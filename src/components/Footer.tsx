    ...
    <footer className="border-t border-slate-200 dark:border-white/5 bg-bg-dark py-12 relative z-10">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400 md:order-none order-last">
          &copy; {currentYear} Muhammad Ali Joya. Built with React, Three.js &amp; Tailwind CSS.
        </p>
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="text-slate-500 dark:text-slate-400 hover:text-cyan-primary dark:hover:text-cyan-400 transition-colors"
            aria-label="GitHub"
          >
