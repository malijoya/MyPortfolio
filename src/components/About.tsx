      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-[350px_1fr] gap-12 md:gap-16 items-center">
          ...
          <div className="relative group mx-auto md:mx-0 w-64 md:w-full aspect-[4/5]">
            ...
            <div className="w-full h-full rounded-2xl border border-slate-200 dark:border-white/10 bg-slate-100/50 dark:bg-white/5 flex items-center justify-center text-slate-500 font-medium overflow-hidden relative">
              {/* Decorative grid pattern */}
              <div className="absolute inset-0 opacity-10 dark:opacity-10 bg-[linear-gradient(to_right,#808080_1px,transparent_1px),linear-gradient(to_bottom,#808080_1px,transparent_1px)] bg-[size:14px_24px]" />
              <div className="z-10 text-center p-6">
                <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-tr from-purple-primary to-cyan-primary flex items-center justify-center text-white text-3xl font-extrabold mb-4 shadow-lg">
                  MA
                </div>
                <h3 className="text-slate-900 dark:text-white font-semibold">Muhammad Ali Joya</h3>
          ...
          <div className="flex flex-col justify-center">
            <p className="text-slate-800 dark:text-slate-200 text-lg font-medium mb-6 leading-relaxed">
              I'm a passionate <strong className="text-purple-primary dark:text-purple-light">Full Stack Developer</strong> who loves crafting clean, performant, and beautiful digital experiences.
            </p>
